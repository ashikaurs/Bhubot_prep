...
//       setOcrSuccess(true);
//       alert('✅ Soil card read successfully! Parameters have been filled automatically.');
//     } else if (response.data.not_soil_card) {
//       alert('❌ This does not appear to be a soil health card. Please upload your government soil health card.');
//     } else {
//       alert('❌ Could not read the card. Please try a clearer image or fill manually.');
//     }
//   } catch (error) {
//     if (error.response && error.response.data.not_soil_card) {
//       alert('❌ This does not appear to be a soil health card. Please upload your government soil health card.');
//     } else {
//       alert('❌ Could not read the image. Please try again or fill parameters manually.');
//     }
//   }
